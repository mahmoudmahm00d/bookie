...
@section('content')
    ...
    <form action="/notifications" method="post" class="col-md-6 needs-validation" novalidate>
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            <input type="checkbox" class="form-check-input" name="public" id="public" checked value="true" />
